"""Kafka consumer for static-analysis service."""
...
OUTPUT_TOPIC = "static.analysis.completed"
CONSUMER_GROUP = "static-analysis"
...
def run_consumer() -> None:
    try:
        ...
        logger.info("static-analysis consumer started")
...
def start_consumer_thread() -> threading.Thread:
    thread = threading.Thread(target=run_consumer, daemon=True, name="static-consumer")
    thread.start()
    return thread
